...
<template>
    ...
    <div class="relative min-h- [100vh] flex-1 rounded-x1 border-sidebar/70 dark:border-sidebar-border md:min-h-min">
        <Table>
            ...
            <TableHeader>
                <TableRow>
                    ...
                    <TableHead class="'text-right'">Gadre</TableHead>
            ...
            <TableBody>
                <TableRow v-for="employee in employees" :key="employee.id">
                    ...
                    <TableCell class="text-right">{{ new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(employee.grade) }}</TableCell>
                    <TableCell as-child size="sm" class="bg-indigo-500 text-white hover:bg-indigo-700">
